...
namespace TeknikServisOtomasyonuProje
{
    public partial class KullaniciGirisForm : Form
    {
        ...
        {
            if (string.IsNullOrWhiteSpace(usernameTB1.Text) || !Regex.IsMatch(usernameTB1.Text.Trim(), @"^[A-Za-z0-9]+$")) // checks if username is empty or has a char other than letters and numbers
            {
                MessageBox.Show("Kullanıcı adı geçersiz.\nLütfen sadece harf ve rakam kullanın.",
                "Hata",
                MessageBoxButtons.OK,
